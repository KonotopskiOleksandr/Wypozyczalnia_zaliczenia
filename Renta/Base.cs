...
namespace Zaliczenia
{
    public static class Base
    {
        ...
        {
            Users.Add(new AllUsers(1, "Jan", " Nowak", "04.03.2021 r.", new DateTime(2021, 3, 04)));
            Users.Add(new AllUsers(2, "Agnieszka", " Kowalska", "15.01.1999 r.", new DateTime(1999, 1, 15)));
            Users.Add(new AllUsers(3, "Robert", " Lewandowski", "18.12.2010 r.", new DateTime(2010, 12, 18)));
            Users.Add(new AllUsers(4, "Zofia", " Plucińska", "29.04.2020 r.", new DateTime(2020, 4, 29)));
            Users.Add(new AllUsers(5, "Grzegorz", " Braun", "12.07.2015 r.", new DateTime(2015, 7, 12)));
